...
export async function onRequest(context) {
  ...
  try {
    ...
    // ✅ FIX: Use getWithMetadata to get both value and metadata together
    const result = await env.FILES_KV.getWithMetadata(actualId, { type: 'text' });
    ...
    const directUrl = result.value; // This is the Telegram URL (string)
    const metadata = result.metadata; // This is the metadata object
